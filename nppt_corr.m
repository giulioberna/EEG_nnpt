function [nppt_corr_results, dummy_res] = nppt_corr(data, covd, type, NBRS, nPerm, tail, alpha, calpha)
%% [nppt_corr_results] = nppt_cor(data, covd, type, NBRS, nPerm, tail, alpha, calpha)
...
% Giulio Bernardi [giulioberna@gmail.com], 2017.11.19
    ...
    nppt_corr_results.z_real=NaN(size(data,2),1);      % z-score
    ...
    [real_res, dummy_res] = perm_corr(data, covd, type, nPerm);
